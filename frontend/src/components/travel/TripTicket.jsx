...
export const TripTicket = ({ trip, onCopyTrip }) => {
  ...
  const handleCopyLink = () => {
    setCopied(true);
    if (onCopyTrip) onCopyTrip();
    setTimeout(() => setCopied(false), 3000);
  };

  const stops = trip?.stops || [];
  const startStop = stops[0] || { cityName: 'TOKYO', code: 'NRT' };
  const midStop = stops[1] || { cityName: 'KYOTO', code: 'KYO' };
  const endStop = stops[stops.length - 1] || { cityName: 'OSAKA', code: 'OSA' };
    ...
    <div className="w-full max-w-3xl mx-auto flex flex-col gap-8 relative z-10">
        ...
        <div className="p-6 sm:p-8 border-b">
          <div className="flex items-center justify-between text-center gap-2">
            ...
            <div className="flex flex-col items-center px-2">
              ...
              <span className="text-[10px] font-bold text-zinc-600 dark:text-zinc-400 uppercase">{midStop.cityName || 'KYOTO'}</span>
            </div>
      ...
      <div className="glass-secondary rounded-3xl p-6 sm:p-8 shadow-lg text-left border">
        ...
        <div className="flex flex-col gap-4">
          <div className="p-4 rounded-2xl glass-secondary border flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 text-sm text-zinc-700 dark:text-zinc-300 font-medium">
                ...
                <span>•</span>
                <span>Tsukiji Food Tour</span>
                <span>•</span>
                <span>Shibuya Night Walk</span>
              </div>
            </div>
            <Badge variant="default">3 Activities</Badge>
          </div>
          ...
          <div className="p-4 rounded-2xl glass-secondary border flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 text-sm text-zinc-700 dark:text-zinc-300 font-medium">
                ...
                <span>•</span>
                <span>Akihabara Quest</span>
                <span>•</span>
                <span>Shinjuku Omoide</span>
              </div>
            </div>
            <Badge variant="default">3 Activities</Badge>
          </div>
          ...
          {showFullItinerary && (
            <>
              <div className="p-4 rounded-2xl glass-secondary border flex items-center justify-between animate-in fade-in">
                <div className="flex items-center gap-4">
                  <span className="text-sm font-mono font-bold text-zinc-950 dark:text-zinc-100">
                    DAY 03 — TOKYO
                  </span>
                  <div className="flex items-center gap-2 text-sm text-zinc-700 dark:text-zinc-300 font-medium">
                    ...
                    <span>•</span>
                    <span>Mori Art Museum</span>
                    <span>•</span>
                    <span>Ginza Evening Promenade</span>
                  </div>
                </div>
                <Badge variant="default">3 Activities</Badge>
              </div>
              ...
              <div className="p-4 rounded-2xl glass-secondary border flex items-center justify-between animate-in fade-in">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 text-sm text-zinc-700 dark:text-zinc-300 font-medium">
                    <span>Shinkansen Bullet Train Transit</span>
                    <span>•</span>
                    <span>Gion Machiya Teahouses</span>
                  </div>
                </div>
                <Badge variant="default">Transit + 1 Activity</Badge>
              </div>
            </>
          )}
        </div>
