...
import { AutoReplannerView } from '../../components/replanner/AutoReplannerView';
import { Button } from '../../components/common/Button';
import { ArrowLeft } from 'lucide-react';

export const AutoReplannerPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 space-y-8 text-left">
      ...
      <AutoReplannerView
        onApply={() => navigate(`/trips/${currentTrip.id}`)}
        onDismiss={() => navigate(`/trips/${currentTrip.id}`)}
      />
    </div>
  );
};
